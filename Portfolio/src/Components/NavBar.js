...
const NavBar = () => {
  ...
  return (
    <div className="sticky top-0 ">
      ...
      <div className="z-50  h-[70px] shadow-md flex justify-between items-center bg-transparent backdrop-blur-sm  mx-auto">
      
        <motion.h2 className="text-2xl font-bold bg-gradient-to-r from-pink-400 via-purple-500 to-blue-500 bg-clip-text text-transparent m-2"
