...
import { SiTailwindcss, SiMongodb, SiExpress, SiMysql,SiOpenai } from "react-icons/si";
...
const groupedSkills = [
  {
    title: "Generative AI",
    items: [
      { name: "LangChain", icon: <MdAutoAwesome className="text-purple-500" /> },
      { name: "LLM", icon: <GiArtificialIntelligence className="text-green-500" /> },
      { name: "RAG", icon: <FaLayerGroup className="text-indigo-400" /> },
      { name: "Transformers", icon: <GiArtificialIntelligence className="text-pink-500" /> },
      { name: "OpenAI", icon: <SiOpenai className="text-black" /> },
      { name: "Gemini", icon: <FaGoogle className="text-blue-600" /> },
    ],
  },
  {
...
const Skills = () => {
  ...
  return (
    ...
    <Element name="projects"><ProjectDetails /></Element>
    </>
  );
};
